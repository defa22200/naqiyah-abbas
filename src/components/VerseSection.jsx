...
export default function VerseSection() {
  return (
    <motion.section 
      ...
      className="py-20 sm:py-28 px-6 text-center max-w-2xl mx-auto relative rounded-t-[60px] sm:rounded-t-[80px] rounded-b-3xl my-16 backdrop-blur-md bg-gradient-to-b from-[#FFFDF9]/95 via-[#FAF4E6]/95 to-[#F5E8CB]/95 border-2 border-[#CBB084]/80 shadow-[0_25px_60px_rgba(180,140,70,0.25)] overflow-hidden text-warm-espresso"
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 sm:w-[450px] h-80 sm:h-[450px] bg-amber-300/20 rounded-full blur-3xl pointer-events-none -z-10"></div>
      ...
      <div className="flex items-center justify-center gap-4 mb-7 relative z-10">
        ...
        <span className="text-[#B88E3E] text-base animate-pulse">✦</span>
      ...
      <blockquote className="space-y-6 sm:space-y-7 relative z-10">
        <div 
          dir="rtl" 
          lang="ar" 
          className="font-arabic text-2xl sm:text-4xl leading-[2.3] sm:leading-[2.5] tracking-wide text-warm-espresso font-bold select-all px-2 drop-shadow-[0_1px_3px_rgba(201,166,107,0.4)]"
        >
          وَمِنْ آيَاتِهِ أَنْ خَلَقَ لَكُم مِّنْ أَنفُسِكُمْ أَزْوَاجًا لِّتَسْكُنُوا إِلَيْهَا وَجَعَلَ بَيْنَكُم مَّوَدَّةً وَرَحْمَةً
        </div>

        {/* Translation in Expressive Serif */}
        <p className="font-serif italic text-base sm:text-xl text-warm-espresso/95 leading-relaxed max-w-lg mx-auto tracking-wide">
        ...
        {/* Citation Tag */}
        <footer className="font-sans text-[10px] sm:text-xs tracking-[0.25em] uppercase text-warm-bronze font-semibold pt-1">
          Surah Ar-Rum 30:21
        </footer>
      </blockquote>
